...
const EditRoompiesLeaflet: React.FC<IEditRoompiesLeaflet> = ({
  locPref,
  setLocPref,
}) => {
...
const AddMarker: React.FC<IEditRoompiesLeaflet> = ({ locPref, setLocPref }) => {
...
export default EditRoompiesLeaflet
